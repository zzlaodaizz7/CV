          ...
          <div class="w20">
            ...
            <ul id="Invite" class="connectedSortable overflow-auto border-bottom-0 w-100 m-0">
              ...
              <div class="info w-100 h-100">
                ...
                <a class="font-weight-bold namecv" target="_blank" href="storage/{{$item->cv}}">{{$item->name}}</a>
          ...
          <ul id="Pass" class="connectedSortable  overflow-auto w-100">
            ...
            <div class="info w-100 h-100">
              <input type="hidden" name="id" value="{{$item->id}}">
                <input type="hidden" name="jobcv" value="{{$item->job}}">
                <input type="hidden" name="emailcv" value="{{$item->email}}">
              <a class="font-weight-bold namecv" href="storage/{{$item->cv}}">{{$item->name}}</a>
              <p class="m-0">{{$item->phone}}</p>
              <i class="m-0">{{$item->job}}</i>
            </div>
          </li>
    ...
    <div class="col-sm-4">
     <div class="form-group">
      ...
      <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
       <input type="text" required class="form-control datetimepicker-input" name="timeinvite" data-target="#datetimepicker1"/>
 ...
 <div class="col-sm-8">
  ...
  <div class="form-group">
   ...
   <div class="custom-control custom-radio">
    <input class="custom-control-input" checked type="radio" id="location1" name="customRadio" value="HN (tòa nhà LE, số 11 ngõ 71 Láng Hạ, Ba Đình, HN)">
  ...
  <div class="col-sm-4">
    ...
    <div class="form-group">
     ...
     <div class="custom-control custom-radio">
      <input class="custom-control-input" checked type="radio" id="people1" name="people" value="Ms Phương: 0338211940">
